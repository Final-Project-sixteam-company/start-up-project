...
실행, Android 연결, Docker Compose, 배포 명령/장애 대응은 `docs/RUN_AND_DEPLOY.md`를 따른다.
...
docs/RUN_AND_DEPLOY.md                      실행 / Android 연결 / Docker Compose / 배포 명령
docs/CLUEROOM_INFRASTRUCTURE_STRATEGY.md    인프라 선택 이유 / 운영 구조 / 확장 계획
```
